...
{//start of namespace
    ...
    {//start of class
        ...
        private void LoadQuestions()
        {
            _questions = new List<QuizQuestion>
            {
                ...
                new QuizQuestion
                {
                    ...
                    CorrectAnswer = "C",
                    Explanation   = "Phishing sites use lookalike URLs to trick users.",
                    IsTrueFalse   = false
                },
                new QuizQuestion
                {
                ...
                new QuizQuestion
                {
                    ...
                    Options       = null,
                    CorrectAnswer = "False",
                    Explanation   = "Public Wi-Fi is often unsecured. Attackers can intercept your data.",
                    IsTrueFalse   = true
                },
                new QuizQuestion
                {
                ...
                new QuizQuestion
                {
                    ...
                    Options       = null,
                    CorrectAnswer = "False",
                    Explanation   = "If one account is compromised all your other accounts are also at risk.",
                    IsTrueFalse   = true
                }
            };
        }
        ...
        //Processes the users answer and returns feedback plus next question
        ...
        //Ends the quiz and returns final score with percentage and personalised feedback
        private string EndQuiz()
        {
            _quizActive = false;
            _awaitingAnswer = false;

            //Show percentage alongside raw score
            double percentage = Math.Round((double)_score / _questions.Count * 100, 1);
            string scoreLine = $"Quiz complete! Your final score: {_score} / {_questions.Count} ({percentage}%)";
            string message;
            ...
            _activityLog.LogAction($"Quiz completed - Score: {_score}/{_questions.Count} ({percentage}%).");

            return $"{scoreLine}\n{message}";
        }

        //Stops the quiz early if the user wants to quit
